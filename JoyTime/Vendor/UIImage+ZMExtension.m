 ...
 *  @return 拉伸好的图片
 */
+ (UIImage *)zm_resizedImageWithImage:(UIImage *)image
{
 ...
 *  @return 切割好的图片
 */
+ (UIImage *)zm_cutImage:(UIImage*)image andSize:(CGSize)newImageSize
{
 ...
 *  @return 切割好的头像
 */
+ (UIImage *)zm_captureCircleImage:(UIImage *)image
{
 ...
 *  @return 切割好的头像
 */
+ (UIImage *)zm_captureCircleImageWithURL:(NSString *)iconUrl andBorderWith:(CGFloat)border andBorderColor:(UIColor *)color
{
    return [self zm_captureCircleImageWithImage:[UIImage imageWithData:[NSData dataWithContentsOfURL:[NSURL URLWithString:iconUrl]]] andBorderWith:border andBorderColor:color];
}
 ...
 *  @return 切割好的头像
 */
+ (UIImage *)zm_captureCircleImageWithImage:(UIImage *)iconImage andBorderWith:(CGFloat)border andBorderColor:(UIColor *)color
{
 ...
 *  @return 返回模糊化之后的图片
 */
+ (UIImage *)zm_blurredImageWithImage:(UIImage *)image andBlurAmount:(CGFloat)blurAmount
{
    return [image zm_blurredImage:blurAmount];
}
 ...
 *  @return 生成的图片
 */
+ (UIImage *)zm_viewShotWithView:(UIView *)view
{
 ...
 *  @return 添加完水印的图片
 */
+ (UIImage *)zm_waterImageWithBgImageName:(NSString *)bgName andWaterImageName:(NSString *)waterImageName
{
 ...
 *  @return 压缩之后的图片
 */
+(UIImage *)zm_reduceImage:(UIImage *)image percent:(float)percent
{
 ...
 *  @return 压缩好的图片
 */
+ (UIImage*)zm_imageWithImageSimple:(UIImage*)image scaledToSize:(CGSize)newSize
{
 ...
 *  @param blurAmount 模糊化指数
 */
- (UIImage*)zm_blurredImage:(CGFloat)blurAmount
{
 ...
 *  @return 模糊好的图片
 */
- (UIImage *)zm_blearImageWithBlurLevel:(CGFloat)blurLevel
{
